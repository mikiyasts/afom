      ...
      <form onSubmit={handleSubmit} onChange={handleForm} style={{width:"50%",margin:"auto",minWidth:"350px",backgroundColor:"#010101",padding:"1rem"}}>
            <div className="form_field">
              ...
              <select name="category" id="category" required style={{color:"white",padding:".5rem",width:"100%",backgroundColor:"transparent",border:"none",borderBottom:"2px solid #f2f2f299"}}>
                <option style={{color:"black"}} value="">Select Dress Category</option>
                <option style={{color:"black"}} value="Wedding">Wedding</option>
                <option style={{color:"black"}} value="Dinner">Dinner</option>
                <option style={{color:"black"}} value="Graduation">Graduation</option>
              </select>
           ...
           <div className="contact_info">
                ...
                <input className="input" id="schedule-time" type="time" min="09:00" max="12:00" required name="time" />
                <p htmlFor='schedule-time' style={{opacity:".5",marginTop:".5rem",display:"flex",alignItems:"center",gap:".5rem"}}><ReportGmailerrorredIcon sx={{width:20}}/> Please pick a time b/n 9am to 12 pm</p>
                <hr className="hr" />
            </div>
           <Calendar
           passDate={getDate}
